...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="Dashboard Resepsionis RSHP Unair">
...
<nav class="navbar">
  ...
  <div class="container">
    <div class="welcome-card">
      ...
      <p>Kelola Registrasi Rumah Sakit Hewan Pendidikan Universitas Airlangga.</p>
  </div>

  <!-- Menu Grid -->
  <div class="menu-grid">
    <a href="{{ route('resepsionis.registrasi-pemilik.create') }}" class="menu-card">
