...
<div class="row">
  <div class="col-md-10">
    <div class="card">
      <div class="card-header pb-0"><h6 class="mb-0">Tambah Dokter Baru</h6></div>
      <div class="card-body">
        <form action="{{ route('admin.data-dokter.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group"><label class="form-control-label">No HP</label><input class="form-control" type="number" name="no_hp" required></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group"><label class="form-control-label">Bidang Keahlian</label><input class="form-control" type="text" name="bidang_dokter" placeholder="Contoh: Bedah, Umum" required></div>
                </div>
                <div class="col-md-6">
