...
<head>
    <meta charset="UTF-8">
    <title>Kategori Klinis - Admin</title>
    <style>
        /* COPY STYLE DARI FILE INDEX KATEGORI DI ATAS */
    ...
    <div class="content-card">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td><strong>{{ $d->nama_kategori_klinis }}</strong></td>
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.kategori-klinis.edit', $d->idkategori_klinis) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('admin.kategori-klinis.destroy', $d->idkategori_klinis) }}" method="POST" onsubmit="return confirm('Hapus?')">
                                @csrf @method('DELETE')
