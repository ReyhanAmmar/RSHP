<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('resepsionis.dashboard') }}">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('resepsionis.dashboard') ? 'active' : '' }}" href="{{ route('resepsionis.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('resepsionis.registrasi-pemilik.*') ? 'active' : '' }}" href="{{ route('resepsionis.registrasi-pemilik.create') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center"><i class="ni ni-single-02 text-warning text-sm opacity-10"></i></div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('resepsionis.registrasi-pet.*') ? 'active' : '' }}" href="{{ route('resepsionis.registrasi-pet.create') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-paw text-success text-sm opacity-10"></i></div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('temu-dokter.*') ? 'active' : '' }}" href="{{ route('temu-dokter.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center"><i class="ni ni-ambulance text-danger text-sm opacity-10"></i></div>
